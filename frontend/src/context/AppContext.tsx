...
const GATEWAY = "http://"; // single entry point

export const utils_service = GATEWAY;
export const auth_service = GATEWAY;
export const user_service = GATEWAY;
export const job_service = GATEWAY;
export const payment_service = GATEWAY;
